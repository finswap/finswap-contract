...
// FinToken with Governance.
contract FinToken is ERC20('FinSwap Token', 'FINS'), Ownable {

    uint256 constant public MAX_TOTAL_SUPPLY = 30000000 * 1e18; // 30,000,000 max fins

    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterChef).
    function mint(address _to, uint256 _amount) public onlyOwner {
        require(_amount.add(totalSupply()) <= MAX_TOTAL_SUPPLY, "ERC20: minting ol MTS");
